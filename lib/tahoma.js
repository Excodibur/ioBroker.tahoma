...
Tahoma.prototype.updateDevice = function (name, deviceData) {
    ...
    for (const commandKey in deviceData.definition.commands) {
        ...
        // nparams for commands seems to be used to indicate the impact of a command:
        ...
        //
        // For now commands for IO devices are limited to classification nparams: 0, as higher commands are to complex to bind them to states
